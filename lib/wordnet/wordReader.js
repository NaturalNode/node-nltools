...
var Synset = _WordNetObject.extend({
  ...
  _related: function(relation_symbol) {
    ...
    // console.log("IN SYNSET", relation_symbol, this._pointers);
    var get_synset = this.wordnetCorpusReader._synsetFromPosAndOffset;

    console.log(this._pointers);
    var pointer_tuples = this._pointers[relation_symbol];
    // console.log(pointer_tuples);
    //  return [get_synset(pos, offset) for pos, offset in pointer_tuples]
